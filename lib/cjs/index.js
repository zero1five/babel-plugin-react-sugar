...
var _default = (0, _helperPluginUtils.declare)(function (api, options) {
  ...
  var visitor = {
    ...
    ArrowFunctionExpression: function ArrowFunctionExpression(path, state) {
      ...
      (0, _utils.setAttr)(path.node.body, t.jSXAttribute(t.jSXIdentifier('key'), t.JSXExpressionContainer((0, _utils.randomStrExpress)())));
    },
    ArrayExpression: function ArrayExpression(path, state) {
      if (path.node.elements[0] && path.node.elements[0].type === 'JSXElement') {
        path.node.elements.forEach(function (element) {
          (0, _utils.setAttr)(element, t.jSXAttribute(t.jSXIdentifier('key'), t.JSXExpressionContainer((0, _utils.randomStrExpress)())));
        });
      }
    }
  };
