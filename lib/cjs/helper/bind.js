...
exports.default = exports.bindHelper = exports.getAndRemoveBindingAttr = void 0;
...
exports.getAndRemoveBindingAttr = getAndRemoveBindingAttr;
...
var bindHelper = function bindHelper(nodePath, bindingValue, attrName) {
  ...
  var wrappedExpr = types.callExpression(addDefault(nodePath, path.resolve('./lib/cjs/runtime'), {
    nameHint: 'binding'
